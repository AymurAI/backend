...
Revision ID: 86bdf2a39c7e
Revises: 
Create Date: 2025-05-25 03:29:14.201556
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "validation_format",
            sa.Enum("NONE", name="datapublicformat"),
            nullable=False,
        ),
        sa.Column("records", sa.JSON(), nullable=True),
        sa.Column("fk_document", sa.Uuid(), nullable=True),
