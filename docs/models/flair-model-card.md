...
Language: **English** | [Español](../es/models/flair-model-card.md)
...
You can also run the model through an AymurAI pipeline.
...
## Description
Please refer to the datapublic entities catalog ([en](../entities/datapublic/README.md)|[es](../es/entities/datapublic/README.md)).
